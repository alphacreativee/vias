import{preloadImages}from"../../libs/utils.js";let lenis;function header(){ScrollTrigger.refresh(),ScrollTrigger.create({start:"top top",end:99999,onUpdate:e=>{0===e.progress&&$("header").removeClass("header--scroll"),.004<e.progress?$("header").addClass("header--scroll"):$("header").removeClass("header--scroll"),1===e.direction?$(".cta-mess").addClass("hide"):$(".cta-mess").removeClass("hide")}})}function footer(){ScrollTrigger.refresh(),gsap.fromTo(".footer-main .data-zoom-in-footer",{scale:1.2,"will-change":"transform"},{scale:1,duration:.5,ease:"none",scrollTrigger:{trigger:".footer-ovl .data-zoom-in-footer",start:"top 75%",scrub:!0}})}function hero(){$("section.hero").length<1||$(".hero-slider").each(function(){var e=$(this);let t;var o=e.attr("data-loop"),r=e.data("autoplay")?{delay:e.data("autoplay")}:e.data("autoplay");t=e.is("[data-speed]")?e.data("speed"):900,new Swiper(e[0],{direction:"vertical",speed:t,loop:o,autoplay:r,preloadImages:!0,parallax:!0,lazy:{loadPrevNext:!0},pagination:{el:".hero .swiper-pagination",clickable:!1,renderBullet:function(e,t){return`
            <button class="${t}">
